  ...
  describe "#create_as_parcelled", vcr: true do
    ...
    context "with success" do
      it "creates a new object" do
        ...
        expect(subject.financial_account_taxes_attributes).to be_empty
        expect(subject.links).to eq([
          {"rel" => "self","href" => "https://sandbox.myfinance.com.br/entities/3798/receivable_accounts/1298985","method" => "get"},
          {"rel" => "destroy","href" => "https://sandbox.myfinance.com.br/entities/3798/receivable_accounts/1298985","method" => "delete"},
          {"rel" => "receive","href" => "https://sandbox.myfinance.com.br/entities/3798/receivable_accounts/1298985/receive","method" => "put"},
          {"rel" => "next","href" => "https://sandbox.myfinance.com.br/entities/3798/receivable_accounts/1298986","method" => "get"},
          {"rel" => "destroy_recurrence","href" => "https://sandbox.myfinance.com.br/entities/3798/receivable_accounts/1298985/recurrence","method" => "delete"}
        ])
      end
    end
